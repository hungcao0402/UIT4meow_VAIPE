...
def get_args(with_deepspeed: bool=False):
    ...
    parser.add_argument("--csv_path", default="/mlcv/WorkingSpace/Personals/hungcv/temp/pipeline/yolov7/results.csv", type=str, help="path csv result")
    parser.add_argument("--output_result", default="", type=str, help="path save results.csv")
